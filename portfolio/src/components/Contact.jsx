...
const socialLinks = [
  ...
  {
    href: 'https://www.instagram.com/https://www.instagram.com/siya__jariwala',
...
const Contact = () => {
  return (
   ...
   >
    ...
    <div className="container lg:grid lg:grid-cols-2 lg:items-stretch max-w-7xl mx-auto">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            <h2 className="headline-2 lg:max-w-[12ch] reveal-up text-3xl">
                Contact me 
            </h2>
            <p className="text-slate-900 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch reveal-up text-2xl">
            ...
            {socialLinks.map(({href,icon},key)=>(
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[backgorund-color,color] hover:bg-zinc-50
...
{icon}
    ...
    <form 
    action="https://getform.io/f/aqomqoqa"
    method='POST'
